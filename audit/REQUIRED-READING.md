...
- **Alexis King** — Functional programming writer (Haskell, Racket). “Parse, Don’t Validate” is the sharpest practical form of the mechanism: a parser returns a type that carries the proof, so the check happens once. [Parse, don’t validate](https://lexi-lambda.github.io/blog/2019/11/05/parse-don-t-validate/)
