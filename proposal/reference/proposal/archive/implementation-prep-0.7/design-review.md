...
Research is closed at the user's request. This review records the design
direction supported by the retained experiments; production integration remains
proposed. The [handoff](RESEARCH-HANDOFF.md) identifies the final evidence boundary.
