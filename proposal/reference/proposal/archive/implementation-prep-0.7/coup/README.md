...
that today's engine accepts the new type. Base Coup with two through six players
...
event operations are proposed extensions. Existing relation declarations,
...
retained as [text](research/source-1.txt) and [HTML](research/source-1.html).
...
Revision 0.5 retains the [resident representation](../representation.md),
[source descriptor](../source-law.md), scope/equality boundary, and ownership/wire
strategy. [Query algebra](../query-algebra.md) specifies the stage behavior.
The [implementation plan](../implementation-plan.md) covers their native integration;
the schema and query machinery for events remain unimplemented. The
