...
pub fn bench<C: Carrier>(width: u32) {
    ...
    for _ in 0..trials() {
        ...
        input_storage = owner
            .inspect_inputs(inputs.keys(), |c, _| c.memory_stats())
            .unwrap();
        ...
        final_storage = owner
            .inspect_inputs(answers.keys(), |c, _| c.memory_stats())
            .unwrap();
    ...
    println!(
        "EVENT_LAB {{\"kind\":\"symbolic_relation_free_join\",\"candidate\":\"{}\",\"bits\":{},\"states\":{},\"identity_mode\":\"{}\",\"input_s\":{:?},\"program_setup_s\":{:?},\"query_s\":{:?},\"owned_compute_s\":{:?},\"iterations\":{:?},\"output_counts\":{:?},\"output_packet_bytes\":{},\"final_arena_bytes_est\":{},\"new_classes\":{},\"input_storage\":{},\"final_storage\":{},\"verified\":true}}",
        C::NAME,
        dimensions,
        size,
