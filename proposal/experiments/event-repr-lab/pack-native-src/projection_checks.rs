//! Independent legal-world partitions, including hidden environments and
//! within-face dependencies that cannot be recognized by whole-face roles.
use super::carrier::*;
...
fn finite<const K: u32, const PREFIX: bool>() {
    ...
    println!(
        concat!(
            "EVENT_LAB {{\"kind\":\"projection_gate_verification\",",
            "\"candidate\":\"{}\",\"product_cases\":{},\"coupled_cases\":{},",
            "\"policies\":3,\"passed\":true}}"
        ),
