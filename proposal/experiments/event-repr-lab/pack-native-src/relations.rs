...
pub(super) fn query_regions<C: RegionOps>(
...
pub(super) fn query_regions_scoped<C: RegionOps>(
    engine: &mut native::Native,
    c: &mut Algebra<C>,
    groups: usize,
    expected_scope: u64,
...
pub fn bench_relations<C: Carrier>(nbits: u32) {
    ...
    for memo in [false, true] {
        ...
        println!(
            "EVENT_LAB {{\"kind\":\"relations_free_join\",\"candidate\":\"{}\",\"product_mode\":\"{}\",\"bits\":{},\"worlds\":{},\"rows\":{},\"groups\":{},\"memo\":{},\"build_s\":{:?},\"join_only_s\":{:?},\"fresh_s\":{:?},\"warm_s\":{:?},\"input_bytes_est\":{},\"final_bytes_est\":{},\"input_nodes\":{},\"final_nodes\":{},\"input_storage\":{},\"final_storage\":{},\"closure_iterations\":{},\"checksum\":{},\"verified\":true}}",
            C::NAME,
            c.product_strategy(),
            nbits,
            n,
