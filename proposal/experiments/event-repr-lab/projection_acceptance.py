...
ap.add_argument('--gates',nargs='+',choices=['joint','active','witness'],default=['active','witness'])
args = ap.parse_args()
...
jobs = [dict(common, EVENT_LAB_CANDIDATE=candidate, EVENT_LAB_LANE=lane,
             EVENT_LAB_PRODUCT=product, EVENT_LAB_RETRACTION_NORMALIZE=mode, EVENT_LAB_RETRACTION_PROJECT=gates)
        ...
        for mode in args.normalize for gates in args.gates]
