...
pub fn bench<C: Carrier>(width: u32) {
    ...
    for memo in [false, true] {
        ...
        for _ in 0..trials() {
            ...
            fresh_count.push(observe.elapsed().as_secs_f64());
        ...
        for _ in 0..trials() {
            ...
            let observe = Instant::now();
            let checksum = output_checksum(c.carrier(), &out);
            warm_count.push(observe.elapsed().as_secs_f64());
            warm.push(start.elapsed().as_secs_f64());
            assert_eq!(black_box(checksum), f.checksum);
            verify(&c, &out, rows);
        }
        println!(
            "EVENT_LAB {{\"kind\":\"legal_relation_free_join\",\"candidate\":\"{}\",\"domain\":\"{}\",\"product_mode\":\"{}\",\"support_gates\":\"{}\",\"bits\":{},\"width\":{},\"environments\":{},\"worlds\":{},\"admissible_worlds\":{},\"rows\":{},\"groups\":16,\"outputs\":80,\"memo\":{},\"build_s\":{:?},\"support_s\":{:?},\"import_s\":{:?},\"admission_s\":{:?},\"join_only_s\":{:?},\"fresh_s\":{:?},\"warm_s\":{:?},\"fresh_compute_s\":{:?},\"fresh_count_s\":{:?},\"warm_compute_s\":{:?},\"warm_count_s\":{:?},\"input_bytes_est\":{},\"final_bytes_est\":{},\"input_nodes\":{},\"final_nodes\":{},\"input_storage\":{},\"final_storage\":{},\"checksum\":{},\"verified\":true}}",
            C::NAME,
            name,
            c.strategy(),
            c.gates(),
