...
pub fn all() {
    ...
    println!(
        "EVENT_LAB {{\"kind\":\"high_coordinate_verification\",\"bits\":40,\"candidates\":9,\"passed\":true}}"
    );
    ...
    println!(
        "EVENT_LAB {{\"kind\":\"coordinate_boundary_verification\",\"candidates\":14,\"extra_orders_per_candidate\":2,\"face_layouts_per_candidate\":3,\"passed\":true}}"
    );
    println!(
        "EVENT_LAB {{\"kind\":\"observation_verification\",\"candidates\":14,\"parameter_groups\":[1,2,3],\"high_coordinate_candidates\":9,\"passed\":true}}"
    );
}
