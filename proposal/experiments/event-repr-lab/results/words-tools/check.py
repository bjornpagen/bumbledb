...
ap=argparse.ArgumentParser();ap.add_argument('--essential-kernel',choices=['words','scalar','derived'],default='words');ap.add_argument('--occupancy-kernel',choices=['scalar','words'],default='scalar');ap.add_argument('--essential-layout',choices=['enum','slab'],default='enum');ap.add_argument('--output',default='fast-check.json');ap.add_argument('--packed-map',choices=['local','recursive'],default='local');ap.add_argument('--transfer-import',choices=['words','direct','recursive'],default='words');args=ap.parse_args()
