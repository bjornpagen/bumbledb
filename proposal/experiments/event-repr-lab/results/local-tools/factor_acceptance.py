...
common=dict(EVENT_LAB_RETRACTION_FACTOR='faces',EVENT_LAB_RETRACTION_COUNT='words',EVENT_LAB_ESSENTIAL_KERNEL='derived',EVENT_LAB_ESSENTIAL_LAYOUT='slab',EVENT_LAB_OCCUPANCY_KERNEL='words',EVENT_LAB_VIEW_KERNEL='words',EVENT_LAB_VIEW_REUSE='bounded',EVENT_LAB_VIEW_NORMALIZE='source',EVENT_LAB_PACKED_MAP='local',EVENT_LAB_TRANSFER_IMPORT='words',EVENT_LAB_IDENTITY='native',EVENT_LAB_LAYOUT='bit-major')
