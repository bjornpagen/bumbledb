...
**Revision 0.5; proposed extension, before implementation.** This specifies the query
...
supplies reference semantics. Revision 0.5 retains the
[canonical BDD/complement-pair carrier](representation.md), with compiled dense
cofactor views where worthwhile. [Source-law.md](source-law.md) specifies the
...
have separate Lean proofs; native relational Pack planning remains future work.
They do not inherit FAQ's arbitrary commutative factor reorderings.
