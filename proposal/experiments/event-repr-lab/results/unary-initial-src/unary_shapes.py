...
ap=argparse.ArgumentParser();ap.add_argument('--output',default='unary-initial-shapes.json');args=ap.parse_args()
...
jobs=list(itertools.product(['composition','coup','bilinear'],['plain','chains'],['face-major','bit-major'],['keep','compact']))
