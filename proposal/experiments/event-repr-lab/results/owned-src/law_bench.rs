    ...
    for parameter_groups in [1, 2] {
        ...
        for memo in [false, true] {
            ...
            let examples_mean: Vec<_> = expected_values
                ...
                .collect();
            println!(
                "EVENT_LAB {{\"kind\":\"law_free_join\",\"candidate\":\"{}\",\"bits\":{},\"worlds\":{},\"rows\":{},\"groups\":{},\"parameter_groups\":{},\"coefficient_bins\":{},\"memo\":{},\"build_s\":{:?},\"join_only_s\":{:?},\"fresh_s\":{:?},\"warm_s\":{:?},\"algebra_s\":{:?},\"contraction_s\":{:?},\"evaluation_s\":{:?},\"input_bytes_est\":{},\"final_bytes_est\":{},\"observation_plan_bytes_est\":{},\"law_bytes_est\":{},\"closure_iterations\":{},\"observations\":240,\"undefined_observations\":80,\"evidence_admissible_worlds\":{},\"examples_beta\":{:?},\"examples_mean\":{:?},\"verified\":true}}",
                C::NAME,
                nbits,
                f.n,
                f.expected_rows,
