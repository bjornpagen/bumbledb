...
files = [folder/'Cargo.toml', folder/'src/lib.rs', LAB/'src/essential_raw.rs', LAB/'src/essential_words.rs', LAB/'src/occupancy.rs', LAB/'src/essential_store.rs', LAB/'src/occupancy_words.rs', LAB/'src/occupancy_scratch.rs']
def digests():
