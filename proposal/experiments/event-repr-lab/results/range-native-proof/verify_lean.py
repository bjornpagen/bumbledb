...
expected = {
    'SharedExit.lean': ['apply_shared','split_selector','complement','normalize',
        'sparse_split','exists_hidden','no_hidden_selector','essential_selector',
        'count_selector','unequal_selectors_obstruction'],
    'UnaryProjection.lean': ['image_exact', 'image_composes', 'image_empty',
        'image_domain', 'image_negation', 'image_preserves_occupancy',
        'hidden_is_union', 'known_nonempty', 'hidden_nonempty',
        'empty_fibre_obstruction', 'normalize_complement'],
    'UnaryChains.lean': ['reify_step', 'compose_eval', 'compose_associative',
        'identity_left', 'identity_right', 'compile_exact', 'run_append',
        'population_complement', 'population_step'],
