...
ap=argparse.ArgumentParser();ap.add_argument('--output',default='unary-initial-check.json');args=ap.parse_args()
...
result=dict(passed=p.returncode==0 and len(records)==1 and len(chains)==1 and len(long_shapes)==4,
