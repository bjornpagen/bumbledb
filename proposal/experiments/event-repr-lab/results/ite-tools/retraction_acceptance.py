...
jobs=[dict(common,EVENT_LAB_CANDIDATE=c,EVENT_LAB_LANE=lane,EVENT_LAB_PRODUCT=mode) for c in ['retraction64','retraction512'] for lane in ['owned','symbolic-relations'] for mode in ['materialized','views']]
