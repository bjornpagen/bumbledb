...
ap=argparse.ArgumentParser();ap.add_argument('--tag',required=True);ap.add_argument('--scope',choices=['regions','observation','transport','essential','classify','storage','views','scoped','admission','retraction','prefix'],default='regions');args=ap.parse_args()
