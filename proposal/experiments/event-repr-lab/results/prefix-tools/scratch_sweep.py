"""Matched allocated-word and bounded-scratch readouts through native Free Join."""
...
ap.add_argument('--scenario', nargs='+', choices=['coup_4290','coup_product_65536','ordered_65536','axes_65536'],
                default=['coup_4290','coup_product_65536','ordered_65536','axes_65536'])
ap.add_argument('--kernel', nargs='+', choices=['words','scratch'], default=['words','scratch'])
...
def save():
    (RESULTS/args.output).write_text(json.dumps(dict(
        experiment='Allocated words versus bounded scratch; same exact readout, traversal and executable',
