"""Matched checked legal-domain relation programs, serial native jobs."""
  ...
  for choice in modes(args.mode if candidate.startswith(('essential','retraction')) else ['materialized']):
   for layout in args.layout:
    for domain in args.domain:
     jobs.append(dict(common,**choice,EVENT_LAB_CANDIDATE=candidate,EVENT_LAB_LANE='legal-relations',EVENT_LAB_ESSENTIAL_LAYOUT=storage,EVENT_LAB_LAYOUT=layout,EVENT_LAB_LEGAL_DOMAIN=domain))
