...
ap.add_argument('--execute',choices=['staged','fused'],default='fused')
ap.add_argument('--completion',choices=['full','needed','local','local-needed'],default='local-needed')
...
common = dict(EVENT_LAB_LANE='readouts', EVENT_LAB_ESSENTIAL_KERNEL='derived',
              ...
              EVENT_LAB_RETRACTION_PROJECT=args.gates, EVENT_LAB_RETRACTION_COMPLETE=args.completion, EVENT_LAB_RETRACTION_EXECUTE=args.execute)
runs = []
