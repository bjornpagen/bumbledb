...
> Source-process research from draft 0.3. Revision 0.5 selects the canonical Event
> representation and its larger relational algebra in [proposal.md](proposal.md).
> [The new adjudication](research/algebra-resolution.md) adds KAD, information
