...
try {
  ...
  const tests = requested.length ? requested : ['event', 'event-query', 'event-probability', 'event-expectation', 'event-descriptor', 'event-source', 'event-polynomial', 'event-parameter', 'event-family', 'event-function-cover', 'event-family-dynamics', 'event-prior', 'event-dynamics', 'event-projections', 'event-selections', 'event-closed', 'statements', 'declared-key', 'law-typing', 'law-scale', 'schema-bindings', 'pure-import',
