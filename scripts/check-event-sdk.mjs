...
try {
  ...
  const tests = requested.length ? requested : ['event', 'event-query', 'event-descriptor', 'event-source', 'event-dynamics', 'event-projections', 'event-selections', 'event-closed', 'statements', 'declared-key', 'law-typing', 'law-scale', 'schema-bindings', 'pure-import',
