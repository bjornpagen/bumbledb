...
try {
  ...
  const tests = requested.length ? requested : ['event', 'event-query', 'event-probability', 'event-expectation', 'event-observation-stages', 'event-query-numbers', 'event-query-predicates', 'event-query-guards', 'event-descriptor', 'event-memory', 'event-action', 'event-source', 'event-polynomial', 'event-parameter', 'event-family', 'event-function-cover', 'event-family-dynamics', 'event-prior', 'event-dynamics', 'event-projections', 'event-selections', 'event-closed', 'statements', 'declared-key', 'law-typing', 'law-scale', 'schema-bindings', 'pure-import',
