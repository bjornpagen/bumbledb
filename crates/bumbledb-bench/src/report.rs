...
fn counters_json(counters: TraceCounters) -> String {
    format!(
        ...
        counters.empty_source_short_circuits,
        ...
        counters.frame_pushes,
        counters.frame_pops,
        counters.binding_copies,
        counters.binding_writes,
        counters.binding_conflicts,
        counters.source_replacements,
