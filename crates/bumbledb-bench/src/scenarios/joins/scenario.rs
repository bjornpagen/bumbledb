use crate::scenarios::{Surface, Twin};
    ...
    Scenario {
        ...
        queries: || {
            vec![
                ScenarioQuery {
                    name: "j1_filmography",
                    surface: Surface::Query(filmography),
                ...
                ScenarioQuery {
                    ...
                    surface: Surface::Query(keyword_kind),
                ...
                ScenarioQuery {
                    name: "j4_five_way",
                    surface: Surface::Query(five_way),
                ...
                ScenarioQuery {
                    ...
                    surface: Surface::Query(country_rollup),
                    params: |_| vec![vec![]],
                ...
                ScenarioQuery {
                    ...
                    surface: Surface::Query(keyword_neighborhood),
