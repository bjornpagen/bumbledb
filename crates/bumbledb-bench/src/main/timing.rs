...
pub(super) fn timed<T, E>(f: impl FnOnce() -> Result<T, E>) -> Result<Timed<T>, E> {
...
pub(super) fn timed_bumbledb_samples<E>(
    samples: u64,
...
pub(super) fn duration_avg(duration: Duration, samples: u64) -> Duration {
    if samples == 0 {
...
pub(super) fn percentile(samples: &[Duration], percentile: u64) -> Duration {
