...
pub const CONSTANTS: &[Constant] = &[
    Constant {
        id: "row-key",
        source: "crates/bumbledb/src/storage/store/keys.rs PhysicalKeyWidths::row",
        value: "10..13 base + 0..16 selected-home bytes (schema-fixed)",
        class: ConstantClass::RepresentationBound,
        owner_lane: "L07",
        disposition: "tag+relation+home+ordinal; base width excludes the relation's home",
    },
    Constant {
        id: "membership-key",
        source: "crates/bumbledb/src/storage/store/keys.rs PhysicalKeyWidths::membership",
        value: "26..29 (schema-fixed)",
        class: ConstantClass::RepresentationBound,
        owner_lane: "L07",
        disposition: "16-byte exact-checked BLAKE3 fingerprint; only unclustered relations retain membership",
    },
    Constant {
        id: "determinant-overhead",
        source: "crates/bumbledb/src/storage/store/keys.rs PhysicalKeyWidths::determinant_overhead",
        value: "10..11 (schema-fixed)",
        class: ConstantClass::RepresentationBound,
        owner_lane: "L01",
        disposition: "secondary key tag+ProjectionId+ordinal; values carry home bytes; selected primary omitted",
    },
    Constant {
