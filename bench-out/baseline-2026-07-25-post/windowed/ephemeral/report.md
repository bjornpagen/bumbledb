...
- timestamp: 2026-08-03T22:23:57Z
- host: Apple M2 Max
- shared machine: boost qos-user-interactive — load 1/5/15 3.67 3.34 3.37 (start) → 3.77 3.37 3.38 (end)
...
|---|---|---|---|
| commit_window_baseline | 29.7 | - | - |
| commit_window_admission | 40.2 | - | - |
| commit_window_exclusion | 35.6 | - | - |
...
|---|---|---|---|---|
| commit_window_baseline | 3.35 | 3.27 | clean | - |
| commit_window_admission | 3.50 | 3.31 | clean | - |
| commit_window_exclusion | 3.51 | 3.32 | clean | - |
