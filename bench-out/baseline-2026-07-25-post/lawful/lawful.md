...
|---|---:|---:|---:|---:|---|
| law_commit_attempt | 4271.792 | 4228.333 | 1.0103 | 64 | one judged Attempt insert per commit under the full law roster (key + containment + capacity) |
| law_commit_cluster | 4943.625 | 4173.917 | 1.1844 | 256 | one judged 4-row cluster per commit: attempt + verdict + steer + scope — every statement family exercised in one commit |
| law_reject_key | 4142.666 | 8.375 | 494.6467 | 64 | one REFUSED duplicate-(task, n) commit per sample (Functionality cited) |
| law_reject_containment | 22.334 | 14.167 | 1.5765 | 64 | one REFUSED absent-task commit per sample (Containment cited) |
| law_reject_window | 21.333 | 7.375 | 2.8926 | 64 | one REFUSED 9th-attempt commit on the saturated task 0 per sample (Capacity cited) |
| law_reject_scope | 15.834 | 6.625 | 2.3900 | 64 | one REFUSED Observe-steer scope commit per sample (the ψ containment cited) |
...
| family | ours p50 µs | sqlite p50 µs | ratio p50 (ours/sqlite) | work | about |
|---|---:|---:|---:|---:|---|
| law_commit_attempt | 23.584 | 18.625 | 1.2663 | 64 | one judged Attempt insert per commit under the full law roster (key + containment + capacity) |
| law_commit_cluster | 46.166 | 59.292 | 0.7786 | 256 | one judged 4-row cluster per commit: attempt + verdict + steer + scope — every statement family exercised in one commit |
| law_reject_key | 15.333 | 3.417 | 4.4873 | 64 | one REFUSED duplicate-(task, n) commit per sample (Functionality cited) |
| law_reject_containment | 8.958 | 5.666 | 1.5810 | 64 | one REFUSED absent-task commit per sample (Containment cited) |
| law_reject_window | 9.500 | 3.167 | 2.9997 | 64 | one REFUSED 9th-attempt commit on the saturated task 0 per sample (Capacity cited) |
| law_reject_scope | 6.542 | 2.750 | 2.3789 | 64 | one REFUSED Observe-steer scope commit per sample (the ψ containment cited) |
