...
- timestamp: 2026-07-19T10:06:16Z
- host: Apple M2 Max
...
clock proxy: 2 block(s) still contaminated after retry — treat their percentiles as dirty: cold_containment_walk, cold_containment_walk_delete.
...
|---|---|---|---|
| cold_containment_walk | 1357.6 | 61.5 | - |
| cold_containment_walk_delete | 3566.3 | 66.3 | - |
...
|---|---|---|---|---|
| cold_containment_walk | 3.26 | 3.16 | CONTAMINATED | - |
| cold_containment_walk_delete | 3.11 | 3.36 | CONTAMINATED | - |
