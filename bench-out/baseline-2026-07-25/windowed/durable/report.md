...
- host: Apple M2 Max
- shared machine: boost qos-user-interactive — load 1/5/15 1.99 2.21 2.60 (start) → 2.07 2.22 2.61 (end)
...
|---|---|---|---|
| commit_window_baseline | 5039.3 | - | - |
| commit_window_admission | 5134.5 | - | - |
| commit_window_exclusion | 5156.1 | - | - |
...
|---|---|---|---|---|
| commit_window_baseline | 3.30 | 1.28 | CONTAMINATED | - |
| commit_window_admission | 1.00 | 0.91 | CONTAMINATED | - |
| commit_window_exclusion | 0.91 | 0.85 | CONTAMINATED | - |
