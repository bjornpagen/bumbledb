...
|---|---:|---:|---:|---:|---|
| law_commit_attempt | 5053.625 | 5154.625 | 0.9804 | 64 | one judged Attempt insert per commit under the full law roster (key + containment + capacity) |
| law_commit_cluster | 5206.625 | 4677.083 | 1.1132 | 256 | one judged 4-row cluster per commit: attempt + verdict + steer + scope — every statement family exercised in one commit |
| law_reject_key | 4562.500 | 14.625 | 311.9658 | 64 | one REFUSED duplicate-(task, n) commit per sample (Functionality cited) |
| law_reject_containment | 41.250 | 26.709 | 1.5444 | 64 | one REFUSED absent-task commit per sample (Containment cited) |
| law_reject_window | 45.875 | 14.000 | 3.2768 | 64 | one REFUSED 9th-attempt commit on the saturated task 0 per sample (Capacity cited) |
| law_reject_scope | 20.417 | 7.042 | 2.8993 | 64 | one REFUSED Observe-steer scope commit per sample (the ψ containment cited) |
...
| family | ours p50 µs | sqlite p50 µs | ratio p50 (ours/sqlite) | work | about |
|---|---:|---:|---:|---:|---|
| law_commit_attempt | 21.750 | 18.083 | 1.2028 | 64 | one judged Attempt insert per commit under the full law roster (key + containment + capacity) |
| law_commit_cluster | 41.416 | 52.459 | 0.7895 | 256 | one judged 4-row cluster per commit: attempt + verdict + steer + scope — every statement family exercised in one commit |
| law_reject_key | 14.041 | 3.167 | 4.4335 | 64 | one REFUSED duplicate-(task, n) commit per sample (Functionality cited) |
| law_reject_containment | 8.458 | 5.333 | 1.5860 | 64 | one REFUSED absent-task commit per sample (Containment cited) |
| law_reject_window | 8.833 | 3.000 | 2.9443 | 64 | one REFUSED 9th-attempt commit on the saturated task 0 per sample (Capacity cited) |
| law_reject_scope | 6.750 | 2.708 | 2.4926 | 64 | one REFUSED Observe-steer scope commit per sample (the ψ containment cited) |
