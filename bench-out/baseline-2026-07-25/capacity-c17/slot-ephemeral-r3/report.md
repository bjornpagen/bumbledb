...
- timestamp: 2026-08-01T23:38:20Z
- host: Apple M2 Max
- shared machine: boost qos-user-interactive — load 1/5/15 1.95 2.39 2.30 (start) → 1.87 2.36 2.29 (end)
...
|---|---|---|---|
| commit_capacity_baseline | 19.4 | - | - |
| commit_capacity_sum | 32.6 | - | - |
...
|---|---|---|---|---|
| commit_capacity_baseline | 3.51 | 3.51 | clean | - |
