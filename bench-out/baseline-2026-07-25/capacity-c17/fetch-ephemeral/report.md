...
- timestamp: 2026-08-01T23:36:36Z
- host: Apple M2 Max
- shared machine: boost qos-user-interactive — load 1/5/15 3.09 2.66 2.37 (start) → 3.16 2.68 2.38 (end)
...
| commit_capacity_sum | 3.50 | 3.45 | clean | - |
