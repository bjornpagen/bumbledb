...
- timestamp: 2026-08-01T23:37:04Z
- host: Apple M2 Max
- shared machine: boost qos-user-interactive — load 1/5/15 2.44 2.54 2.34 (start) → 2.44 2.54 2.34 (end)
...
|---|---|---|---|
| commit_capacity_baseline | 19.5 | - | - |
| commit_capacity_sum | 35.7 | - | - |
| commit_capacity_duration | 34.5 | - | - |
...
| commit_capacity_duration | 3.50 | 3.40 | clean | - |
