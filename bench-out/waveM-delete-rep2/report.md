...
- timestamp: 2026-07-19T10:06:11Z
- host: Apple M2 Max
...
clock proxy: 1 block(s) still contaminated after retry — treat their percentiles as dirty: cold_containment_walk.
...
|---|---|---|---|
| cold_containment_walk | 1356.4 | 59.4 | - |
| cold_containment_walk_delete | 3554.4 | 56.8 | - |
...
|---|---|---|---|---|
| cold_containment_walk | 3.13 | 3.26 | CONTAMINATED | - |
