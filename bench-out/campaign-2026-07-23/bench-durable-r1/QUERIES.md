...
Family-list digest: `0df0bc03edbf8b1bbec506f09bab946e69b0e56f25d1b3ef28506fc446c38204`.
...
```sql
SELECT DISTINCT t3."name", t1."source", t0."amount", t0."at" FROM "Posting" AS t0, "JournalEntry" AS t1, "Account" AS t2, "Holder" AS t3 WHERE t0."entry" = t1."id" AND t0."account" = t2."id" AND t2."holder" = t3."id" AND t0."at" >= ?1
```

Params: 4 suffix edges near the corpus end (at >= edge selects ~2/4/6/8%) — chain's draws, shared.
