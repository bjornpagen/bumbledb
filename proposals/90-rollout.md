...
`conformance/v3/*`. **Spec:** [20](20-command-codec.md),
...
- [x] A: codec v2 (header + ops) + braids + goldens + fuzz + alloc windows — 4c2b431e, a4e852ea, 445d1f49, 699c792d, a4c6aeda, 2f806975, 0e93dfc3, c21d3a20 landed the lane; the one-path pass deleted the wire's carried conflict section with its derivation and routing (16b3426f) and regenerated the corpus bless-style as header + ops (e92f889e) — the version stays 2 because no release ever shipped the sectioned layout. The three `ChainMismatch` causes are apply-time goldens in conformance/v3/chain, per 20 they are chain checks, not codec refusals
