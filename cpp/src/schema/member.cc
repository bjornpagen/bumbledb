...
[[nodiscard]] consteval auto is_coord_type(std::meta::info type) -> bool {
...
template<class T>
[[nodiscard]] consteval auto is_facade() -> bool {
...
template<class T>
[[nodiscard]] consteval auto is_member() -> bool {
...
[[nodiscard]] consteval auto coordinate_label() -> std::string {
...
template<class First, class... Rest>
[[nodiscard]] consteval auto same_relation() -> bool {
	return ((Rest::relation_name == First::relation_name) && ...);
}

template<class First, class... Rest>
[[nodiscard]] consteval auto span_message(std::string_view constructor, std::string_view law) -> std::string {
	return "bumbledb " + std::string{constructor} + "(): coordinates span two relations — \"" + coordinate_label<First>() + "\" and \"" +
