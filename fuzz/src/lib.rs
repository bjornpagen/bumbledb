...
fn schema_variant(rejection: &SchemaError) -> &'static str {
    match rejection {
        ...
        SchemaError::CardinalityInvertedWindow { .. } => "CardinalityInvertedWindow",
        SchemaError::CardinalityVacuousWindow { .. } => "CardinalityVacuousWindow",
        SchemaError::CardinalityContainmentWindow { .. } => "CardinalityContainmentWindow",
