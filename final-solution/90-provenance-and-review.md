...
Current handoff: **ready for the owner's syntax sanity check, then coordinated implementation**. No implementation starts as part of this revision. The new obligations extend existing gate families instead of adding a parallel SDK qualification framework.
