...
| FFI-05 Owned values | Mutable input after acceptance cannot affect work. Failed/reentrant builder ingestion spends construction and releases accumulated native ownership without GC; no partial reuse. Result/page copies survive their documented owner lifetime; intoCursor spends/transfers once. Close/reuse/cancel cannot expose a mapping-backed JS view. |
