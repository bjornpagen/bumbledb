...
- Historical legacy detail: the measured runtime was direct because the old executor first attempted a deleted count kernel, marked `runtime_kind = DirectKernel`, and returned without LFTJ execution when it succeeded.
