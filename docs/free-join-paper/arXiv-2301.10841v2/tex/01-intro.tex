...
implement~\cite{DBLP:journals/sigmod/NgoRR13}.  These algorithms have
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{free-join.pdf}
...
This finer-grained view of join algorithms allows \FJ
  ...
  converts it into a new kind of plan that we call an \FJ plan.  It
...
To evaluate \FJ, we implemented it as a standalone Rust library, and
