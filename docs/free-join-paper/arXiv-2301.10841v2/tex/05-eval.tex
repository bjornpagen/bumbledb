...
\begin{enumerate}
    \item How does \FJ perform compared to binary join and \GJ, on acyclic and cyclic queries?
...
\begin{figure*}
  ...
  \begin{minipage}[t]{.33\textwidth}
    ...
    \captionof{figure}{Run time on JOB queries.}
    \label{fig:eval:imdb}
  \end{minipage}%
  \begin{minipage}[t]{.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{robust.pdf}
    \captionof{figure}{Run time w/ bad cardinality estimate.}
    \label{fig:robust}
  \end{minipage}
  \begin{minipage}[t]{.33\textwidth}
    \centering
    ...
    % }
    \captionof{figure}{Run time on LSQB queries.
...
\begin{figure*}
  ...
  \begin{minipage}{.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{lsqb.pdf}
    \captionof{figure}{LSQB run time w/ factorized output.}
...
As Figure~\ref{fig:robust} shows, 
