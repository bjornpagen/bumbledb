#!/usr/bin/env python3
"""Same saved triangle and observer as M1, with E1's isolated early exit."""
import argparse
import json
import shutil
...
assert force.replace(hook, b'') == git('show', 'HEAD:crates/bumbledb/src/exec/colt/force.rs')
...
phase = Phase(f'e1-saved-{args.attempt}')
...
try:
    ...
    binary = phase.path/'e1-saved-test'
