...
owns reconstructed, checked native objects. This is a foundation for query face
imports and SDK transport; those consumers are not implemented by this change.
...
Query import syntax, SDK descriptors, measured-source descriptors and integrated
