...
and canonical BEVT v2 persistence. The complete
...
density partitions, symbolic contraction and measured context identity. The
complete query algebra, conditional/parameterized sources, TypeSafe imports,
