...
It does not implement conditional categorical generators, shared polynomial
parameters, guarded rational or general semialgebraic functions, solver
certificates, TypeSafe import intents or database observation query results.
