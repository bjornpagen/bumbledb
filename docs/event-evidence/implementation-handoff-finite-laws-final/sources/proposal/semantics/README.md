...
The native semantic modules add **286 checked reports across seventeen files** in
[the current native run](../../docs/event-evidence/native-finite-law-semantics/check.json):
...
[FiniteDensity](../../crates/bumbledb-event/semantics/FiniteDensity.lean). These are
