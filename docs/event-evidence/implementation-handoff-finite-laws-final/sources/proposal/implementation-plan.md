...
descriptors required by M6. Scope each passing gate to the supported format;
...
reports. Conditional channels, parameter families, solver capabilities, TypeSafe
adapters and query observation heads keep this gate open.
