...
The [current native semantic run](event-evidence/native-query-probability-semantics/check.json) adds
**547 reports / 33 files**, using only permitted standard Lean axioms.
...
The [qualification](event-evidence/native-query-probability-qualification-final/check.json)
...
observations/descriptions/pages. The [handoff](event-evidence/implementation-handoff-query-probability-final/check.json)
...
query arithmetic, Expectation aggregates, general prior integration, multivariate
