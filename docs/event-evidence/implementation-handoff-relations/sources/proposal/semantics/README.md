...
The native semantic modules add **85 checked reports across five files** in
[the current native run](../../docs/event-evidence/relation-semantics/check.json):
...
[Relations](../../crates/bumbledb-event/semantics/Relations.lean). These are
