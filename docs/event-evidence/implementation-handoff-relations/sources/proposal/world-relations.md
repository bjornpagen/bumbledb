...
and graph/readout conversion. The finite host API does not yet supply complete
descriptor transport, raw diagram inspection, query staging or parameter/source
integration. This status does not change their mathematical contract.
