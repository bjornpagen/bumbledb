...
`codex/event-algebra`. The [relation core](event-relations.md) now builds on it;
the complete source/query/transport API remains later work. It neither changes
...
parameter maps, diagram inspection and query stages remain acceptance work.
