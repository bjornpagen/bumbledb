...
parameterized sources and graph inspection remain separate implementation work.
...
raw diagram inspection, query operator programs/stages, and integrated performance.
