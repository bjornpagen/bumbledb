...
**Revision 0.9.** The [proposal proof rerun](results/native-handoff-0-9/check.json) checks
...
The native semantic modules add **207 checked reports across twelve files** in
[the current native run](../../docs/event-evidence/native-query-semantics/check.json):
...
[Query](../../crates/bumbledb-event/semantics/Query.lean). These are
...
python3 scripts/check-event-semantics.py \
  --lean /Users/bjorn/.elan/toolchains/leanprover--lean4---v4.32.0/bin/lean \
