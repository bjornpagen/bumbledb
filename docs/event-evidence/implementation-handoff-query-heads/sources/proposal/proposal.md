...
this diagnostic contract for same-space constructive heads and structural tests.
...
Query.lean proves the reference participation and collection laws. Event Pack,
face imports, relational programs and certified factoring still need integration.
