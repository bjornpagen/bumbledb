...
The base Event grammar and final Probability heads are implemented on the branch;
observation staging and Expectation remain proposed:
...
The caller still supplies scalar equality/value mapping; query aggregate heads,
group extraction, coverage admission and observation result slots remain open.
...
observation staging/arithmetic and Expectation aggregates remain proposal gates.
