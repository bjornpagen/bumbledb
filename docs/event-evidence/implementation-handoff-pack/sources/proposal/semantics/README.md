...
The native semantic modules add **226 checked reports across thirteen files** in
[the current native run](../../docs/event-evidence/native-pack-semantics/check.json):
...
[Pack](../../crates/bumbledb-event/semantics/Pack.lean). These are
