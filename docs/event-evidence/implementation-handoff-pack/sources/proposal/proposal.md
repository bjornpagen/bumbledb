...
implementation below supplies stable descriptors; extending them through imported
faces, relational programs and factored execution remains acceptance work.
