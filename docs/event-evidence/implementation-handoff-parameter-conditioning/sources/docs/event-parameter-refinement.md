...
This slice does not introduce a wire encoding for the refinement certificate or
add SDK refinement authoring/query instructions. Those remain consumer work.
No public wire version, package version or release changes.
...
accounting. Multivariate solving, parameter-changing maps, general family dynamics,
query observations, TypeSafe import intents, complete SDK and M0–M8 qualification
remain required.
