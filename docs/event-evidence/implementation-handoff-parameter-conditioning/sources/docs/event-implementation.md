...
The [current native semantic run](event-evidence/native-parameter-conditioning-semantics/check.json) adds
**474 reports / 29 files**, using only permitted standard Lean axioms.
