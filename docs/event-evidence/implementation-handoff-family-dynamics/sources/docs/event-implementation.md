...
The [current native semantic run](event-evidence/native-family-dynamics-semantics/check.json) adds
**513 reports / 31 files**, using only permitted standard Lean axioms.
