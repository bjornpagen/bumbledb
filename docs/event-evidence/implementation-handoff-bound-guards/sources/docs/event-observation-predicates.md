...
dynamic binding of one source per plan; common refinement across several source
presentations remains a separate obligation.
...
Thirty-five `PredicateGuards.lean` reports establish exact truth coding,
...
Multiple-source query refinement,
