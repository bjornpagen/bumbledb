...
The four relational Lean reports establish denotational laws. The subsequent
[native relational experiment](RELATIONAL-PACK.md) now implements composition
and residual aggregates with checked legal faces and shared environments.
Together with the six original rewrite reports
