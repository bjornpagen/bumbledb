...
def main():
    ...
    for source in (ROOT / "docs/event-implementation.md", ROOT / "docs/event-value-format.md",
                   ...
                   ROOT / "docs/event-partitions.md", ROOT / "docs/event-actions.md", ROOT / "docs/event-belief-memory.md",
                   ROOT / "docs/event-queries.md", ROOT / "docs/event-query-binders.md", ROOT / "docs/event-priors.md", ROOT / "docs/event-function-covers.md", ROOT / "docs/event-query-probability.md", ROOT / "docs/event-query-expectation.md", ROOT / "docs/event-observation-stages.md", ROOT / "docs/event-observation-numbers.md", ROOT / "docs/event-observation-predicates.md", ROOT / "docs/event-descriptors.md",
                   ...
                   ROOT / "docs/event-sdk.md", ROOT / "docs/event-sdk-polynomials.md",
                   ROOT / "docs/event-sdk-parameters.md",
                   ROOT / "docs/event-sdk-families.md",
                   ROOT / "docs/event-sdk-family-dynamics.md",
                   ROOT / "docs/event-selections.md",
                   ROOT / "docs/event-ground.md", ROOT / "docs/event-polynomials.md",
                   ROOT / "docs/event-algebraic-roots.md", ROOT / "docs/event-parameter-domains.md",
                   ROOT / "docs/event-algebraic-identity.md", ROOT / "docs/event-parameter-sources.md",
                   ROOT / "docs/event-parameter-refinement.md",
                   ROOT / "docs/event-parameter-conditioning.md",
                   ROOT / "docs/event-parameter-expectations.md",
                   ROOT / "docs/event-family-functions.md",
                   ROOT / "docs/event-family-dynamics.md"):
