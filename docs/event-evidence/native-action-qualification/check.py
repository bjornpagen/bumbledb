...
def main():
    ...
    result = {
        "scope": ("Native finite Event maps, relations, diagram inspection, information, sealed fixed-point programs, indexed partitions and fully observed strategy witnesses; belief-memory/source/query integration and full M0–M8 remain open; no performance qualification"
