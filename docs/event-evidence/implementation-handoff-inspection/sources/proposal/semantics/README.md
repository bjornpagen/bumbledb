...
The native semantic modules add **95 checked reports across six files** in
[the current native run](../../docs/event-evidence/inspection-semantics/check.json):
...
[Relations](../../crates/bumbledb-event/semantics/Relations.lean) and
[Inspection](../../crates/bumbledb-event/semantics/Inspection.lean). These are
