...
The [current native semantic run](event-evidence/native-family-transport-semantics/check.json) adds
**533 reports / 32 files**, using only permitted standard Lean axioms.
...
The [transport qualification](event-evidence/native-family-transport-qualification/check.json)
...
The [transport handoff](event-evidence/implementation-handoff-family-transport/check.json)
