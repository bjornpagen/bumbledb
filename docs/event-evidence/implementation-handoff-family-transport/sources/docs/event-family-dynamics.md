...
Event values and checked maps use existing BEVT v3 and BEDC persistence. The [BESC v2 source envelope](event-source-descriptors.md) now transports family
functions, channels, refinements, restrictions and full replayed revision receipts.
Complete TypeScript authoring/results remain open. Multivariate/general function
