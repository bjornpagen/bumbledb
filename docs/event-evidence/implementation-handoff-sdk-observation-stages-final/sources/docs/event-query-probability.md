...
forced spill and append rollback, combined shape bounds and typed interior
staging. SDK tests cover owned
...
[Observation stages](event-observation-stages.md) now retain probability
outputs in Rust interiors and typed SDK relation expressions. Imported bindings,
description replay and forwarding preserve their exact query domain and owned
source/evidence identity. Query arithmetic over observations,
