...
explicit role/support certification. BESC source construction, complete consumer
APIs and the aggregate retained-memory gate remain open.
...
Coup posteriors and signed utility survive persistence/reopen. Kernel/revision
SDK operations, parameter families, provider provenance and native query
observation/aggregate heads remain open; this does not close M6 or M7.
