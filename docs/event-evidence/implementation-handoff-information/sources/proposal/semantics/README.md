...
The native semantic modules add **114 checked reports across seven files** in
[the current native run](../../docs/event-evidence/information-semantics/check.json):
...
[Information](../../crates/bumbledb-event/semantics/Information.lean). These are
