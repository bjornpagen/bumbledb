...
readouts and all six map operations, with exact input/output contexts. Relation
query/source/SDK integration remains acceptance
...
face imports, full relation programs, structured SDK diagnostics and
