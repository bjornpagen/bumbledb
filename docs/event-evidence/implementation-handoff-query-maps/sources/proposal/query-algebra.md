...
with checked input/output contexts. Probability/Expectation and relational/face-import query
...
to relation faces and factored schedules remains required. Captured map boundaries
