...
def main():
    ...
    result = {
        ...
        "scope": ("Native finite Event maps, relations, diagram inspection, information, sealed fixed-point programs, indexed partitions, fully observed strategy witnesses and exact fixed finite laws/BEVT v2; belief-memory/source/full query integration and M0–M8 remain open; no performance qualification"
