...
one environment. Finite observables, expectation, action/permission programs,
progress/strategy witnesses, continuous-source certificates and query integration
remain required by this gate.
