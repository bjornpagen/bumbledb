...
The native semantic modules add **150 checked reports across nine files** in
[the current native run](../../docs/event-evidence/native-fixed-point-semantics/check.json):
...
[Closure](../../crates/bumbledb-event/semantics/Closure.lean). These are
