...
This is a finite, unmeasured host API. The environment is an actual finite
...
now supply least/greatest iteration and structural closure. M7's finite
observables, expectation and action availability/permissions remain implementation
work, as do query heads and measured sources in their own milestones.
