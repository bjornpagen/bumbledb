...
This foundation does not complete M4: full fibre products, role certificates,
world relations, residuals and graph views remain. A surjectivity certificate
never substitutes for a complete-fibre-square or law-pushforward certificate.
