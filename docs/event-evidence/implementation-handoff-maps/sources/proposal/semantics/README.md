...
The native semantic modules add **63 checked reports across four files** in
[the current native run](../../docs/event-evidence/map-semantics/check.json):
...
[CoordinateMaps](../../crates/bumbledb-event/semantics/CoordinateMaps.lean). These are
