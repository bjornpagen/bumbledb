...
The native semantic modules add **266 checked reports across sixteen files** in
[the current native run](../../docs/event-evidence/native-query-relation-semantics/check.json):
...
[QueryRelations](../../crates/bumbledb-event/semantics/QueryRelations.lean). These are
