...
branch; constructive query heads and general strategy/program transport remain
open. Named belief-memory compilation now has BEBA replay and SDK strategy result
