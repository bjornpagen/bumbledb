...
named compilation with SDK knowledge/strategy consumers are implemented; native
query memory construction, general host-program/strategy transport and continuous-source
certificates remain required by this gate.
