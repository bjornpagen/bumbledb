...
def main():
    ...
    if args.queries:
        checks[4][1].extend(["--test", "event_queries"])
    ...
    result = {
        "query_scope": ("Complete-binding Event/Test heads, stable context fault sets, raw Node descriptors; Pack, face imports, relational programs, full SDK and certified factoring remain open" if args.queries else None),
