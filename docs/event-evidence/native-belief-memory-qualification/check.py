...
def main():
    ...
    if args.relations:
        checks[4][1].extend(["--test", "event_relations", "--test", "event_fixed_points",
                             "--test", "event_partitions", "--test", "event_actions", "--test", "event_beliefs"])
    if args.queries:
