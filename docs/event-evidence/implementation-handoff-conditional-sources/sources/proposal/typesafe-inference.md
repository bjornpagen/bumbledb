...
yet the complete Coup engine fixture or a TypeSafe adapter. Import intents,
raw-response receipts, Jeffrey/likelihood revisions, law-family constraints,
continuous shared parameters and observation query heads keep their gates open.
