...
The native semantic modules add **304 checked reports across eighteen files** in
[the current native run](../../docs/event-evidence/native-conditional-source-semantics/check.json):
...
[WeightedMaps](../../crates/bumbledb-event/semantics/WeightedMaps.lean). These are
