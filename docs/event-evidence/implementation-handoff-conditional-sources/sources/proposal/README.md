...
and normalized conditional channels while preserving parent marginals. The complete
...
images and conditional closure, with explicit outcome names and actor FD checks. The
complete query algebra, source revisions/parameterized sources, TypeSafe imports,
