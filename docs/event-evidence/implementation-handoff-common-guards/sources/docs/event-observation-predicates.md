...
multiple-source query refinement and direct parameter-region consumers remain
...
hidden unresolved companions. The macro refusal roster contains 60 fixtures.

Parameter-region query consumers, dynamic/multiple-source query refinement,
