...
multivariate/general function solving, family likelihood/Jeffrey dynamics and
channels/prior integration, family receipt transport,
...
General parameter-dependent payoff values remain open. Query
