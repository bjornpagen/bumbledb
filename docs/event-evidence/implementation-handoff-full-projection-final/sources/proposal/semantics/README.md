...
The native semantic modules add **37 checked reports across three files** in
[the current native run](../../docs/event-evidence/full-projection-semantics/check.json):
