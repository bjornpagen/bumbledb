#!/usr/bin/env python3
"""Qualify finite Event maps and, with --relations, relation/information algebra.
...
def main():
    ...
    parser.add_argument("--relations", action="store_true", help="Include native relation-result integration")
    ...
    if args.relations:
        checks[4][1].extend(["--test", "event_relations"])
    result = {
        "scope": ("Native finite Event maps, relations, diagram inspection and information algebra; source/query integration and full M0–M8 remain open; no performance qualification"
