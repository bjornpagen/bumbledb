...
Common guard refinement/lifts, scope-changing maps, multivariate/general function
solving, family dynamics/prior integration, TypeSafe intents, observation query
heads and complete family SDK authoring/results remain required M6 work.
