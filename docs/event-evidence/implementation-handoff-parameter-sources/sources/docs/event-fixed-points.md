...
composition plan through [typed relation heads](event-queries.md). General
Least/Greatest query binders, measured expectation, belief-memory construction,
general program/strategy transport and integrated performance remain open gates.
