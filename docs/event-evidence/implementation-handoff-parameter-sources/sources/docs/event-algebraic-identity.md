...
This supplies standalone arithmetic transport. [Parameterized Event sources](event-parameter-sources.md)
now use it to retain exact domains and guard predicates in BEVT v3. These
arithmetic formats alone do not declare a source, choose a prior or turn
parameter cells into stochastic alternatives.
