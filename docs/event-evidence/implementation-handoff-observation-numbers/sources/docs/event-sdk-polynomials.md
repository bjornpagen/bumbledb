...
is made. [Exact domains, regions, roots and partial functions](event-sdk-parameters.md)
now expose the next univariate layer. [Live families and owned observations](event-sdk-families.md)
now consume it. Complete family dynamics and remaining M0–M8 work stay open.
No package version change or release.
