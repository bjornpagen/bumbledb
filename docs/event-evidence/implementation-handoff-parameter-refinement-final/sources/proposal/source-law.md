...
guard partitions. Explicit common refinement/lifts are implemented below;
...
query refinement instructions and parameter/domain-changing maps remain required.
