...
parameter across each map. Their exact guard partitions must agree. Explicit
...
guards before rechecking map admission. Scope/domain-changing maps remain open.
