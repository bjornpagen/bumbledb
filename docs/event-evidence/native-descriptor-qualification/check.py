...
def main():
    ...
    if args.queries:
        checks[4][1].extend(["--test", "event_queries", "--test", "event_pack"])
    ...
    result = {
        "query_scope": ("Complete-binding Event/Test heads and grouped Event Pack, stable context fault sets, raw Node descriptors; face imports, relational programs, full SDK and certified factoring remain open" if args.queries else None),
