...
heads now have a native implementation; observation staging and Expectation
remain open.
...
Query observation/expectation heads and the other full M6 gates remain open.
...
query arithmetic. Expectation roster aggregation, remaining solver/prior/import
