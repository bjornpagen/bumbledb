...
The [current native semantic run](event-evidence/native-query-binders-semantics/check.json) adds
**606 reports / 36 files**, using only permitted standard Lean axioms.
