...
quantifiers share that boundary. Captured guard plans now return ordinary Event cases, including common truth
refinement and exact transport. Dynamic/multiple-source query refinement and the
...
heads and quantifiers now share this staging boundary. Captured single-source guard construction, common predicate refinement and exact
transport now share this boundary. Certified factoring and dynamic/multiple-source
...
returns ordinary Events using an explicit captured source and predicate roster.
...
Twenty-nine PredicateGuards Lean reports prove the reference world/truth transport
and common-partition laws, not the Rust implementation.
...
BENP v2 replays Region leaves while existing trees keep v1 identity. Dynamic
source naming, multiple-source query refinements and general semialgebraic
solving remain separate obligations.
