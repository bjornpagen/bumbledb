...
individual and common source refinements. Captured guard queries additionally
resolve a bound predicate roster on one source; dynamic/multiple-source query
...
solving, parameter-changing maps, dynamic/multiple-source query refinements,
TypeSafe import intents, complete SDK and M0–M8 qualification remain required.
[Captured guard queries](event-observation-predicates.md) now refine one source
