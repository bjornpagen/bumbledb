...
schema. [Exact Event selections](event-selections.md) can filter these laws.
[Event-valued closed rosters](event-ground.md) now use the same checked coverage
and explicit pointwise keys. Event capacity positions remain guarded.
