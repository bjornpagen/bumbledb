...
byte equality of arbitrary defining polynomials. Multivariate elimination and
parameterized source transport remain required.
...
source ownership/contraction and canonical source transport remain required integration.
...
formats do not yet encode parameterized Event sources or designate a joint law.
