...
def main():
    ...
    result = {
        "sdk_scope": ("Owned Event field/carriers, worker-backed host algebra, stored-field generated bindings, native dependency admission, persistence/reopen, literals/parameters, Pack, ownership/cancellation and related SDK regressions; full worker-side ingress and constructive query/source SDK APIs remain open" if args.sdk else None),
