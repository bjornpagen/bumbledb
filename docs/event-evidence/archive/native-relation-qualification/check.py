#!/usr/bin/env python3
"""Qualify checked finite Event maps and, with --relations, their relation core.
...
def main():
    ...
    result = {
        "scope": ("Native finite Event maps and relation algebra; source/query integration and full M0–M8 remain open; no performance qualification"
