...
**Revision 0.8; normative proposal, not implemented engine syntax.** This is the
...
| --- | --- | --- |
| `Event` | A region in one captured, nonempty world space | Proposed two-word EventKey and owned canonical completed-function manager |
