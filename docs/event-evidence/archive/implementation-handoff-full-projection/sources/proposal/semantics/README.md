...
The native semantic modules add **30 checked reports across three files** in
[the current native run](../../docs/event-evidence/admission-semantics-initial/check.json):
...
[Admission](../../crates/bumbledb-event/semantics/Admission.lean). These are
