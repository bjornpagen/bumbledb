...
The native semantic modules add **20 checked reports across two files** in
[the current native run](../../docs/event-evidence/fixed-point-boundaries/check.json):
[Persistence](../../crates/bumbledb-event/semantics/Persistence.lean) and
[FixedPoint](../../crates/bumbledb-event/semantics/FixedPoint.lean). These are
