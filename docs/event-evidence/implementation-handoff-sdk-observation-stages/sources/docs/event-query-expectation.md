...
[Native observation stages](event-observation-stages.md) now let Rust queries
project and join completed expectations through interiors. The typed SDK still
refuses those interiors, and numerical observation arithmetic remains open.
Those boundaries must expand; they do not narrow the proposal.
