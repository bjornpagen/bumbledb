...
**Research closed.** The [handoff](../../RESEARCH-HANDOFF.md) is the current entry
point. The last validated native extension is [relational Pack](RELATIONAL-PACK.md).
The [participation-index draft](PARTICIPATION-STATUS.md) is shelved without a
successful build or measurements. Historical sources, binaries and results are retained.
...
The completed [readout round](results/readout-final-audit.json) is frozen.
