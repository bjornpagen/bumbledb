...
[qualification](event-evidence/native-revision-qualification-wakeup/check.json) pin this
slice. BEVT v2 carries posterior laws and BEDC carries translation maps. Receipt,
function and kernel transport, full SDK construction, parameterized revisions,
TypeSafe adapters and query observation/expectation heads remain unfinished.
