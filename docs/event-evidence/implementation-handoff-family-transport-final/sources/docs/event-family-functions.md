...
[BESC v2](event-source-descriptors.md) now transports these functions and replays
the complete receipts. Multivariate/general semialgebraic functions, explicit
prior integration, SDK authoring/results and owned query observations/aggregate
coverage remain required. No release or
