...
build on this domain contract. [Family channels and Jeffrey revisions](event-family-dynamics.md)
and [BESC v2 replayed transport](event-source-descriptors.md) are now implemented.
