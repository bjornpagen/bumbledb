...
retains the existing 594 semantic reports. Event selections, Event capacity
positions, Event-valued closed rosters and the remaining M0–M8 gates remain open.
