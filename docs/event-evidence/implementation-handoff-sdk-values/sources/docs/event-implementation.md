...
not claim mathematical admission. Contextual full terms and Event schema literals
remain guarded; complete worker-side ingress and query/source APIs remain open.
...
transport/authoring, not those mathematical models. Complete worker-side ingress,
constructive SDK query/source operators and the other M0–M8 gates remain open.
