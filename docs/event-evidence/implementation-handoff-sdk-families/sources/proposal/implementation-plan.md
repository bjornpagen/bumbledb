...
expose individual guard refinements. Family dynamics/restrictions/common-refinement
consumers, complete query APIs and the aggregate retained-memory gate remain open.
...
builders, exact signed observations and individual guard refinements. Family
channels/revisions/restrictions, common refinement rosters and query observation
heads remain open.
