...
The native semantic modules add **237 checked reports across fourteen files** in
[the current native run](../../docs/event-evidence/native-descriptor-semantics/check.json):
...
[Descriptors](../../crates/bumbledb-event/semantics/Descriptors.lean). These are
