...
def main():
    ...
    result = {
        ...
        "scope": ("Native finite Event maps, relations, diagram inspection, information, sealed fixed-point programs, indexed partitions, fully observed strategy witnesses and exact finite laws/BEVT v2, weighted images, conditional source closure, fixed-law revisions, signed expectations and BESC v1 checked source transport, univariate shared-parameter sources/BEVT v3, fibre-normalized guarded laws, owned conditional functions, equivalent-partition parameter maps/products, checked common guard refinements/lifts/exact descent/readout transport and finite logical-atom fixed points; refinement certificate/query integration, multivariate solving, family dynamics, belief-memory/full query integration and M0–M8 remain open; no performance qualification"
