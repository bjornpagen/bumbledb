...
Certified factoring and observation staging/arithmetic keep M5 open.
...
staging/arithmetic remains open. Exact rational imports and finite/family
function payoff query slots now use checked local covers.
...
## Native observation-stage checkpoint
...
The typed SDK query-variable domain still needs observation support, and
