...
position. This is an implemented unmeasured M3 slice; it does not close the full
...
constant. High-level SDK authoring and generated Event bindings remain pending;
the raw specification transport preserves the complete typed projection.
