...
The native semantic modules add **185 checked reports across eleven files** in
[the current native run](../../docs/event-evidence/native-action-semantics/check.json):
...
[Actions](../../crates/bumbledb-event/semantics/Actions.lean). These are
