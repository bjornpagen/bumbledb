...
core schema/database/codec paths and generated bindings. Event-valued closed
rosters and Event capacity projections retain their explicit native guards.
Managed log schema converters still need the owned input-stage migration. The
complete SDK still needs general fixed-point programs,
