...
canonical identity through native judgment, Rust byte literals, managed core
SDK schemas and generated bindings. Their tests include empty/nonempty zero-mass
values. Event capacity projections and Event-valued closed rosters remain guarded;
managed log schema converters still need owned literal ingress.
