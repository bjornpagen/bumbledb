...
branch now persists unmeasured Events; the pointwise admission and planner laws
below remain mandatory next steps. See the [native ledger](../docs/event-implementation.md).
