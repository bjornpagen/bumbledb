...
def main():
    ...
    if args.queries:
        checks[4][1].extend(["--test", "event_queries", "--test", "event_pack", "--test", "event_query_maps", "--test", "event_query_relations", "--test", "event_query_fixed_points", "--test", "event_expectations", "--test", "event_query_payoffs", "--test", "event_observation_stages", "--test", "event_observation_numbers", "--test", "event_query_numbers"])
