#!/usr/bin/env python3
"""Qualify checked finite Event maps and, with --relations, relations and inspection.
...
def main():
    ...
    result = {
        "scope": ("Native finite Event maps, relation algebra and diagram inspection; source/query integration and full M0–M8 remain open; no performance qualification"
