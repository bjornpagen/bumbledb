...
def main():
    ...
    for source in (ROOT / "docs/event-implementation.md", ROOT / "docs/event-value-format.md",
                   ...
                   ROOT / "docs/event-queries.md", ROOT / "docs/event-query-binders.md", ROOT / "docs/event-priors.md", ROOT / "docs/event-function-covers.md", ROOT / "docs/event-query-probability.md", ROOT / "docs/event-query-expectation.md", ROOT / "docs/event-descriptors.md",
