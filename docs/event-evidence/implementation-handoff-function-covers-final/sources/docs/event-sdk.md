...
missing query-observable rows as zeros. The [native expectation aggregate](event-query-expectation.md) now establishes
...
needs host-program/strategy/memory transport and observation staging/arithmetic.
