...
The [current native semantic run](event-evidence/native-function-covers-semantics/check.json) adds
**639 reports / 38 files**, using only permitted standard Lean axioms.
