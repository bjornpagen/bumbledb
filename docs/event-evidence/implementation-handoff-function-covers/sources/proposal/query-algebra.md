...
The native query collector now supplies exact integer equality, group extraction,
coverage admission and owned observation result slots. Rational/function payoff
query slots and observation staging/arithmetic remain open.
