...
Structured transport of the Rust fault records remains pending. The existing
...
from a worker's semantic refusal. SDK descriptor/source construction, structured
diagnostics and aggregate retained-memory policy remain separate gates.
