...
Native pointwise field admission now has separate implementation and Lean evidence.
Contextual projection constants, the relation/query algebra, measured sources and
integrated qualification remain the work specified by the implementation plan.
