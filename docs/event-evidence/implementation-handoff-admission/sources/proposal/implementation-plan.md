...
This does not close M3: contextual full projection terms still need typed
declaration/wire/fingerprint/compiler support and their own missing-context and
coverage tests. Event selections, capacity positions and closed rosters remain
guarded. Zero-mass/nonempty source cases require the measured-source integration.
