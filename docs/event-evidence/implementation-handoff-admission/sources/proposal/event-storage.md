...
branch now persists unmeasured Events and checks pointwise field dependencies,
including the conservative planner rules below. Contextual projection constants
and the complete integration gates remain open. See the
