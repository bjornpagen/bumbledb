...
The native semantic modules add **163 checked reports across ten files** in
[the current native run](../../docs/event-evidence/native-partition-semantics/check.json):
...
[Partitions](../../crates/bumbledb-event/semantics/Partitions.lean). These are
