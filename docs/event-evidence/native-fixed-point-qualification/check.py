#!/usr/bin/env python3
"""Qualify finite Event maps and, with --relations, relations and finite programs.
...
def main():
    ...
    result = {
        "scope": ("Native finite Event maps, relations, diagram inspection, information and sealed fixed-point programs; source/query integration and full M0–M8 remain open; no performance qualification"
