...
Events in native/macro/Node/SDK queries. Certified factoring, dynamic/common
refinement query construction and complete parameter-region consumers keep M5 open.
