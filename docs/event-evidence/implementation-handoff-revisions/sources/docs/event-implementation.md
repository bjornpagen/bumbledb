...
The [revision qualification](event-evidence/native-revision-qualification/check.json)
and [current handoff](event-evidence/implementation-handoff-revisions/check.json)
