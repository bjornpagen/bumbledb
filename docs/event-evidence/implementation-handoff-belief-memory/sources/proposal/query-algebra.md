...
implemented. Observation staging/arithmetic and general Least/Greatest query
binders remain proposed; the complete Coup templates
...
final Probability/Expectation forms compile too; observation staging/arithmetic and
general fixed-point binders retain their separate gates.
...
captured maps and typed relation views/modalities. `RelationExpr` carries the
...
and general Least/Greatest query binders remain future additions.
