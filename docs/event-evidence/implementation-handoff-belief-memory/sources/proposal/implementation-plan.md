...
and final integer Expectation heads now have native implementations; observation
staging/arithmetic and rational/function payoff query slots remain open.
...
integration, rational/function payoff query slots, continuous-source certificates
and general bound fixed-point query integration remain required by this gate.
