...
This implements the first part of M6; conditional channels, parameter families,
solver capabilities, TypeSafe adapters and query observation heads remain open.
...
slice. Conditional categorical generators, shared polynomial parameters,
