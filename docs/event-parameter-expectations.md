...
Event regions and its omitted regions have an explicit zero default. It does
not yet add payoffs whose values themselves vary continuously with the parameter.
Parameter-dependent probabilities already come from the designated family law.
