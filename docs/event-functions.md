...
parameters, solver capabilities, source revision/adapters and observation query
...
pin the implemented slice. Kernel/function descriptor transport, high-level SDK
construction, source revisions, parameter families and adapters remain open.
