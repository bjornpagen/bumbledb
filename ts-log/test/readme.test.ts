...
test("every ts fence in README.md type-checks against src at HEAD", function readmePin() {
	...
	// The fence project lives INSIDE the package so bare specifiers (effect,
